                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.posts.update',$posts->id)}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                   
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="simpleinput">Enter your Blog Title</label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="title" value="{{$posts->title}}" id="simpleinput" class="form-control" placeholder="Write a catchy blog title">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="form-control selectpicker" name="category" data-style="btn-primary"  >
                                                                ...
                                                                <option value="job">Religion</option>
                                                            </select>                                                          
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" name="firstDescription" rows="15" id="example-textarea"  placeholder="Write your blog">{{$posts->firstDescription}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" name="secondDescription" rows="15" id="example-textarea"  placeholder="Write your blog">{{$posts->secondDescription}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" name="thirdDescription" rows="15" id="example-textarea"  placeholder="Write your blog">{{$posts->thirdDescription}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" name="fourthDescription" rows="15" id="example-textarea"  placeholder="Write your blog">{{$posts->fourthDescription}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10"> 
                                                            <textarea class="form-control" name="fifthDescription" rows="15" id="example-textarea"  placeholder="Write your blog">{{$posts->fifthDescription}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control" name="highlightedText" rows="15" id="example-textarea" placeholder="Write a highlighted text for this blog">{{$posts->highlightedText}}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <p>Select an image</p>
                                                        ...
                                                        <img src="{{url($posts->image)}}" class="img-thumbnail" style="height: 70px;width:auto;">
                                                    </div>
