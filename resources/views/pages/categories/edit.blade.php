            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Category & Slug update table</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Start updating your Category Name & Slugs </h4>
                                    <p class="sub-header">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.categories.update',$categories->id)}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                   
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="simpleinput">Enter your Brand Name</label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="brandname" value="{{$categories->categoryname}}" id="simpleinput" class="form-control" placeholder="Edit your Brand Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" name="slug" value="{{$categories->slug}}" id="simpleinput" class="form-control" placeholder="Edit your Brand Slug">
                                                        </div>
                                                    </div>
