            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Color & Slug update table</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Start updating your Color Name & Slugs </h4>
                                    <p class="sub-header">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.colors.update',$colors->id)}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                   
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="simpleinput">Enter your Brand Name</label>
                                                        <div class="col-md-10">
                                                            <input type="text" name="colorname" value="{{$colors->colorname}}" id="simpleinput" class="form-control" placeholder="Edit your Brand Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" name="slug" value="{{$colors->slug}}" id="simpleinput" class="form-control" placeholder="Edit your Brand Slug">
                                                        </div>
                                                    </div>
