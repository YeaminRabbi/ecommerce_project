        ...
        <div class="container-fluid">
            ...
            @include('alert.messages')
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Start Writing your Brand name & Slug</h4>
                                    <p class="sub-header">
                                            ...
                                            <div>
                                                <form action="{{route('admin.brands.store')}}" enctype="multipart/form-data" method="POST">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" name="brandname" id="simpleinput" class="form-control" placeholder="Write a brand name which you want to add in your store" autocomplete="off">
                                                        </div>
                                                    </div>
